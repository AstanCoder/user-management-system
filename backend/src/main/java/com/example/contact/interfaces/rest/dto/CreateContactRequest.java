...
public class CreateContactRequest {
    ...
    @Schema(description = "Company name", example = "Acme Corp", maxLength = 200)
    @Size(max = 200)
    private String company;

    @Schema(description = "Job title", example = "Sales Manager", maxLength = 150)
    @Size(max = 150)
    ...
    @Schema(description = "Country code or name", maxLength = 100)
    @Size(max = 100)
